...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{Route('editActionJob')}}" id="formEditJob" enctype="multipart/form-data">
                    @csrf
                    <input type="string" name="id_job" value="{{$data->id_job}}" hidden>
                    <div class="row mt-2">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="category">
                                ...
                                <option value="fulltime" @if($data->category == "fulltime") selected @endif>Full-time</option>
                                <option value="partime" @if($data->category == "partime") selected @endif>Part-time</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="mt-3">
                        <button type="button" class="btn btn-success" id="buttonEditJob">Update data</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('buttonEditJob').addEventListener('click', function() {
            Swal.fire({
                title: 'Konfirmasi',
