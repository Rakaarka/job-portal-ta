    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6 padding_right_0">
                <div><img src="{{asset('user/assets/images/about-img.png')}}" class="about_img" /></div>
            </div>
        </div>
    </div>
</div>
...
<div class="blog_section layout_padding">
    <div class="container">
        ...
        <div class="play_icon_main">
            <div class="play_icon">
                <a href="#"><img src="{{asset('user/assets/images/play-icon.png')}}" /></a>
            </div>
        </div>
    </div>
</div>
...
<div class="client_section layout_padding">
    <div class="container">
        <h1 class="client_taital">Profesional</h1>
                        ...
                        <div class="client_main">
                            <div class="box_left">
                                <p class="lorem_text">
                                    ...
                                    commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugia
                                </p>
                            </div>
                            <div class="box_right">
                                <div class="client_taital_left">
                                    <div class="client_img"><img src="{{asset('user/assets/images/client-img.png')}}" /></div>
                                    <div class="quick_icon"><img src="{{asset('user/assets/images/quick-icon.png')}}" /></div>
                                </div>
                                <div class="client_taital_right">
                                    <h4 class="client_name">Sadriwan Putra Simamora</h4>
                                    <p class="customer_text">Data Analyst</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="client_main">
                            ...
                            <div class="box_right">
                                ...
                                <div class="client_taital_right">
                                    <h4 class="client_name">Rafli Aditya</h4>
                                    <p class="customer_text">Fullstack Web Developer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="client_main">
                            ...
                            <div class="box_right">
                                ...
                                <div class="client_taital_right">
                                    <h4 class="client_name">Yahoo Garfield Manik</h4>
                                    <p class="customer_text">Front-End Developer</p>
                                </div>
                            </div>
                        </div>
                    </div>
